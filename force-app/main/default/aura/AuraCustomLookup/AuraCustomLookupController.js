({
    search : function(component, event, helper) {
        ...
        // Object Info
        action.setParam('objectApiName', component.get('v.sObjectApiName'));
        action.setParam('fieldApiName',  component.get('v.fieldApiName'));
        action.setParam('subFieldApiName',  component.get('v.subFieldApiName'));
